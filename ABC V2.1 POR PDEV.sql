...
--UPDATE PRECIOS
UPDATE REFERENCIAS SET CLASIFICACIONPdeV17 = (SELECT ClasificacionPdeV17 FROM Clasificacion_Final_ABC_PreciosPdeV17 WHERE Clasificacion_Final_ABC_PreciosPdeV17.REFERENCIA = REFERENCIAS.REFERENCIA) WHERE REFERENCIA IN (SELECT REFERENCIA FROM Clasificacion_Final_ABC_PreciosPdeV17);
--UPDATE MOVIMIENTOS
UPDATE REFERENCIAS SET CLASIFICACIONPdeV17 = CLASIFICACIONPdeV17 + (SELECT ClasificacionPdeV17 FROM Clasificacion_Final_ABC_MovimientosPdeV17 WHERE Clasificacion_Final_ABC_MovimientosPdeV17.REFERENCIA = REFERENCIAS.REFERENCIA) WHERE REFERENCIA IN (SELECT REFERENCIA FROM Clasificacion_Final_ABC_MovimientosPdeV17);
--SEGUNDO UPDATE
